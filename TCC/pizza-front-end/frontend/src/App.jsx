...
function ProtectedRoutes() {
  ...
  return <Routes><Route element={<MainLayout />} path="/"><Route index element={<DashboardPage />} /><Route path="pdv" element={<PosPage />} /><Route path="cozinha" element={<KitchenPage />} /><Route path="pedidos" element={<OrdersPage />} /><Route path="mesas" element={<TablesPage />} /><Route path="caixa" element={<CashPage />} /><Route path="cardapio" element={<MenuPage />} /><Route path="estoque" element={<InventoryPage />} /><Route path="compras" element={<PurchasesPage />} /><Route path="clientes" element={<CustomersPage />} /><Route path="financeiro" element={<FinancePage />} /><Route path="comercial" element={<CommercePage />} /><Route path="automacoes" element={<AutomationsPage />} /><Route path="relatorios" element={<ReportsPage />} /><Route path="configuracoes" element={<SettingsPage />} /><Route path="auditoria" element={<AuditPage />} /><Route path="*" element={<Navigate to="/" replace />} /></Route></Routes>;
}
