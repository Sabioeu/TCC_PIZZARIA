...
export default function MainLayout() {
  const [open, setOpen] = useState(false); const [notificationsOpen, setNotificationsOpen] = useState(false); const [profileOpen, setProfileOpen] = useState(false); const [installPrompt, setInstallPrompt] = useState(null);
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${open ? 'open' : ''}`}>
      <div className="brand-block"><span className="brand-mark"><Icon name="pizza" /></span><div className="brand-copy"><strong>Aurora Pizza</strong><span>Operating System</span></div><button type="button" aria-label="Fechar menu" className="icon-button sidebar-close" onClick={() => setOpen(false)}><Icon name="close" /></button></div>
